...
public class Job {
	...
	public Job(int id, String name, String email, String contactNo, int career, String educationalBg, String price,
			String title, boolean parmanentPosition, int hit, com.hansing.entity.JobType jobType, Member member,
			List<com.hansing.entity.JobType> jobTypes) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
	...
	public String toString() {
		return "Job [id=" + id + ", name=" + name + ", email=" + email + ", contactNo=" + contactNo + ", career="
				...
				+ ", parmanentPosition=" + parmanentPosition + ", hit=" + hit + ", JobType=" + JobType + ", member="
