...
public class Member {
	...
	public Member(String id, String pwd, String name, String nickname, List<MemberRole> memberRoles, List<Room> rooms,
			List<Job> jobs, List<Market> markets, List<MarketComment> marketComments,
			List<CommunityComment> communityComments, List<Community> communities, List<Store> stores) {
		super();
		this.id = id;
		this.pwd = pwd;
		this.name = name;
	...
	public String toString() {
		return "Member [id=" + id + ", pwd=" + pwd + ", name=" + name + ", nickname=" + nickname + ", memberRoles="
				+ memberRoles + ", rooms=" + rooms + ", jobs=" + jobs + ", markets=" + markets + ", marketComments="
				+ marketComments + ", communityComments=" + communityComments + ", communities=" + communities
				+ ", stores=" + stores + "]";
	}
